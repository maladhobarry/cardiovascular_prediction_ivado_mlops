...
class PreprocessData:
    ...
    def remove_outliers(self, df=None, columns_list=None, quantiles_list=None):
        """
    ...
    def bin_age(self, df=None, age_edges_list=None, age_labels_list=None, is_day=True):
        """
    ...
    def calculate_bmi(self, df=None, weight_col='weight', height_col='height'):
        """
    ...
    def calculate_map(self, df=None, ap_lo_col='ap_lo', ap_hi_col='ap_hi'):
        """
    ...
    def drop_columns(self, df=None, columns_to_drop=None):
        """
    ...
    def save_data(self, df=None, path=''):
        """
    ...
    def process_file(self, origin_path='', destination_dir=''):
        """
